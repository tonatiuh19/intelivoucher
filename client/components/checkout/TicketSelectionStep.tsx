        ...
        <Form className="space-y-6">
          ...
          {includesTransportationOffer && (
            <div className="space-y-4">
                ...
                {({ field }) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2 rounded-lg border border-slate-200 dark:border-slate-700 p-3">
                      ...
                      <Label htmlFor="mode-van" className="cursor-pointer">
                        {t("checkout.van")} (included)
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2 rounded-lg border border-slate-200 dark:border-slate-700 p-3">
                      <RadioGroupItem id="mode-flight" value="flight" />
                      <Label htmlFor="mode-flight" className="cursor-pointer">
              ...
              {(values.transportationMode === "van" ||
                values.transportationMode === "flight") && (
                        ...
                        <div className="space-y-2">
                          ...
                          <RadioGroup
                            ...
                            onValueChange={(value) => {
                              ...
                              // Clear personalization fields if switching to standard
                              if (!isPersonalized) {
                                setFieldValue(`jerseyNames.${i}`, "");
                                setFieldValue(`jerseyNumbers.${i}`, "");
                                setFieldValue(`jerseySizes.${i}`, "");
                              }
                            }}
