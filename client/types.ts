...
export interface ApiEvent {
  ...
  event_time: string;
  image_url: string;
  is_sold_out: string | number;
  is_trending: string | number;
  includes_transportation: string | number;
  is_presale: string | number;
  requires_ticket_acquisition: string | number;
  refundable_if_no_ticket: string | number;
  accepts_under_age: string | number;
  jersey_addon_available: string | number;
  jersey_price: string;
  created_at: string;
  updated_at: string;
  active: string;
